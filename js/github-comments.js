...
function DoGithubComments(comment_id, page_id) {
    ...
    var url = "https://github.com/egecue/blog/issues/" + comment_id;
    ...
    $(document).ready(function() {
        ...
        $.ajax(api_comments_url, {
            ...
            error: function(xhr) {
                $("#gh-comments-list").append("Bu gönderi için yorumlar mevcut değil. " + xhr.status);
            }
        });
    });
}